...
<body>
    <nav class="navbar navbar-expand-lg bg-success">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-4 text-light" href="#">Edit Barang</a>
        </div>
    </nav>

    <form action="{{ route('update_barang', $edit_barang->kode_barang) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="container mt-3 w-50">
            <div class="mb-3">
                ...
                <input type="text" id="disabledTextInput" name="kode_barang" class="form-control"
                    value="{{ $edit_barang->kode_barang }}" required>
            </div>
            <div class="mb-3">
                ...
                <input type="text" id="disabledTextInput" name="merek_barang" class="form-control"
                    value="{{ $edit_barang->merek_barang }}" required>
            </div>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Kategori</label>
                <input type="text" id="disabledTextInput" name="tipe" class="form-control"
                    value="{{ $edit_barang->tipe }}" required>
            </div>
            <div class="mb-3">
                ...
                <input type="text" id="disabledTextInput" name="tahun" class="form-control"
                    value="{{ $edit_barang->tahun }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="file" class="form-control" name="gambar" id="inputGroupFile02"
                        value="{{ $edit_barang->gambar }}">
                </div>
                <div class="gambar mt-3">
                    <img src="{{ asset('storage/' . $edit_barang->gambar) }}" alt="" style="width: 20%;">
                </div>
            </div>
